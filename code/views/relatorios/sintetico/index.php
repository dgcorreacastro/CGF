<main class="py-4">
    <div id="relSintetico" class="personContainer">

      <div class="card-body">
          <div class="card-create-header">
              <h2 class="pageTitle"> <button title="Baixar Excel" type="button" class="btn btn-success btnExcel py-2 px-3 m-1 dn" onclick="downloadRelScreen('bodySintetico')"><i class="fas fa-file-excel" style="font-size:22px;color:white"></i></button>
          ...
          <div class="card-create-body">
              ...
              <div class="TableRelatorios" style=" display: flex; flex-direction: column; flex-wrap: nowrap; align-items: center;">
                  <table id="table" class="table table-striped customScroll" style="position: sticky; top:0; z-index:3; margin-bottom: 0; max-width:fit-content;">
                      <thead>
                        <tr class="headerTr topHeader">
                          ...
                          <th scope="col" colspan="4">Viagem</th>
                        ...
                        <tr class="headerTr applyWidth">
                          ...
                          <th class="tdBorder5" scope="col" style="min-width: 72px !important;">Prefixo</th>
                          <th scope="col" style="min-width: 18.8vw !important; max-width: 18.8vw !important;">Descrição</th>
                          <th class="tdBorder5" scope="col" style="min-width: 72px !important;">Chegada<br>Prevista</th>
                          ...
                          <th class="tdBorder5" scope="col" style="min-width: 70px !important;">Cad.</th>
                  ...
                  <table id="table" class="table table-striped tBodyScroll" style="white-space: normal; max-width:fit-content;">
    ...
    <div class="filtroDivNew">
        ...
        <div class="btsFiltro">
          <button title="Buscar" type="button" class="btn btn-warning btnRelatorio btnBuscar" onclick="gerarRelatorioSintetico()"> <i class="fa fa-search"></i><b>Buscar</b></button>
        </div>
                ...
                <div class="row bg-primary text-white mx-0 mb-1 p-1 w-100 d-flex align-items-center">
                  ...
                  <div class="btnsAgenda">
                    ...
                    <?php if($agendamento->isready == 1):?>
                      <i title="Ver Agendamento" class="fas fa-eye bg-success p-1 viewDate-<?php echo date('d-m-Y', strtotime($agendamento->created_at));?>" onclick="gerarRelatorioSintetico(false, <?php echo $agendamento->id;?>)"></i>
                    <?php endif;?>
