...
<html lang="pt-BR">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>assets/css/mapaEuroNew.css?v=<?php echo $_SESSION['cgfVersion'] ?? 1;?>" />
	...
	<body id="body" style="background-image: url('<?php echo BASE_URL; ?>assets/images/background.jpeg')">
		...
		<script type="text/javascript" src="<?php echo BASE_URL; ?>assets/js/mapaEuroNewCommon?v=<?php echo $_SESSION['cgfVersion'] ?? 1;?>"></script>
  		<script type="text/javascript" src="<?php echo BASE_URL; ?>assets/js/mapaEuroNewEdit.js?v=<?php echo $_SESSION['cgfVersion'] ?? 1;?>"></script>
