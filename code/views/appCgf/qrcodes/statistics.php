<main class="py-4">
    <div class="personContainer">
        <div class="card-body">
            ...
            <h2 class="pageTitle"> <b class="h4">&#10148; <?php echo $nomegr;?></b></h2>
    ...
    <div class="filtroDivNew">
            ...
            <form action="" method="get" class="form-horizontal form-label-left w-100" name="getStatistics" id="getStatistics">
                ...
                <div class="btsFiltro">
                    <button title="Baixar Excel" type="button" class="btn btn-success btnRelatorio btnExcel" onclick="statisticsAppExcel()"><i class="fas fa-file-excel"></i></button>
