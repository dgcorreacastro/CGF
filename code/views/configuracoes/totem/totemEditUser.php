<main class="py-4">
    <div class="personContainer">
        <form method="POST" action="/configuracoes/atualizarTotemUser" accept-charset="UTF-8" class="form-horizontal">
        <div class="card-body">
            <div class="card-create-header">
                <h2 class="pageTitle"> <b class="h4">&#10148; Editar Passageiro</b></h2>
            </div>
            <hr>
            <div class="card-create-body">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <input class="form-control" name="LINK" type="text" id="LINK" value="<?php echo $totemEdt['LINKUSER']; ?>">
                    </div>
        ...
        <div class="checkboxesFiltro" id="gruposSel">
            ...
            <div class="checkboxesFiltroLista">
                ...
                <?php };?>
                <label for="gr-<?php echo $gr['ID_ORIGIN'] ?>"><?php echo $gr['NOME'] ?></label>
                <?php endforeach; ?>
            </div>
