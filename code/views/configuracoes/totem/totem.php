                    ...
                    <table id="table" class="table table-striped customScroll" style="position: sticky; top:0; z-index:3; margin-bottom: 0; max-width:fit-content;">
                        <thead>
                            <tr class="headerTr applyWidth" style="background: #0468bf !important;">
                                ...
                                <th scope="col">
                                    <a title="Novo Cadastro" href="/configuracoes/totemCreate/" class="btn btn-success"><i class="fas fa-plus"></i></a>
                                </th>
                            </tr>
                        </thead>
                    </table>
                        ...
                        <tbody id="bodyTotem">
                            <?php foreach($totem as $tot): ?>
                                <tr class="toMark" id="<?php echo $tot['id'] ?>">
                                    ...
                                    <td scope="col" style="width: 510px !important;"><?php echo utf8_encode(BASE_URLB . 'rotas/itinerario/' . $tot['LINK']); ?></td>
                                    <td scope="col" style="width: 130px !important;">
                                        <div class="d-flex flex-row flex-nowrap justify-content-between px-2 align-items-center">
                                            <b><?php echo $tot['acessos']; ?></b>
                                            <form action="/configuracoes/statisticsTotem" method="get">
                                    ...
                                    <td scope="col" style="width: 180px !important;">
                                        ...
                                        <a title="Editar" href="/configuracoes/totemEdit?id=<?php echo $tot['id'] ?>" class="btn btn-primary mx-2 editIcon"><i class="fas fa-edit"></i></a>                                        
                                        <button title="Excluir" class="btn btn-danger mx-2 editIcon" onclick="confirmDelet('Link', '<?php echo $tot['NOME'] ?>', '/configuracoes/totemDel', <?php echo $tot['id'] ?>)"><i class="fas fa-trash"></i></button>
                                        
                                        <input class="textLinkUrl" type="text" value="<?php echo utf8_encode(BASE_URLB . 'rotas/itinerario/' . $tot['LINK']) ?>" id="textLink-<?php echo $tot['id'] ?>">
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
