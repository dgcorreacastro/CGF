<div class="card-create-body">
    <div class="row">
            ...
            <select name="grupo" class="form-control" required>
                ...
                <?php foreach($grupos AS $gr): ?>
                    ...
                    <?php if(
                        ...
                        ( isset($funcao) && $funcao->grupoID == $gr['ID_ORIGIN'] )
                    ) { ?>
        ...
        <div class="col-sm-6 col-xs-12">
            ...
            <?php } else if( isset( $funcao )) { ?>
                <input class="form-control" name="descricao" type="text" id="descricao" required value="<?php echo $funcao->descricao; ?>" />
                <input class="form-control" name="id" type="hidden" value="<?php echo $funcao->id; ?>" />
            <?php } else { ?>
