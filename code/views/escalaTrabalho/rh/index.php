<main class="py-4">
    <div class="personContainer">
        <div class="card-body">
            <h2 class="darkcyan"><i class="far fa-calendar-alt darkcyan"></i> Listagem de Escalas</h2>
            <div id="filtros">
                <form id="formFilterEsc" method="GET" action="/rh/" accept-charset="UTF-8" class="form-horizontal">
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">

                            <select name="u" class="form-control controlPerson">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <select name="s" class="form-control controlPerson">
            ...
            <table id="table" data-toggle="table" class="table table-bordered">
                <thead>
                    <tr class="headerTr">
                        ...
                        <th style="min-width: 70px !important; width: 150px"> </th>
                    </tr>
                </thead>
                <tbody id="listEscala">
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a title="Visualizar" href="/rh/show?id=<?php echo $r->id ?>" class="btn btn-primary editIcon"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody> 
