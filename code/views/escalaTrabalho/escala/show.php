    ...
    <div class="personpersonContainerEscala">
        <div class="card-body">
            ...
            <div class="card-create-header">
                <h2 class="darkcyan"><i class="far fa-calendar-alt darkcyan"></i> Escala</h2>
            </div>
            <hr>
            ...
            <div class="card-create-body">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        ...
                        <select name="unidadeID" id="unidade" class="form-control controlPerson" disabled>
                            <option value="">Selecione</option>
                        
                            <?php foreach($unidades AS $un): ?>
                                <option 
                                    value="<?php echo $un->id; ?>"
                                    <?php echo $escal['escala']->unidadeID == $un->id ? 'selected' : ''; ?>
        ...
        <div class="card-create-footer">
            <div class="row d-flex justify-content-end">
                ...
                <?php if( $escal['escala']->efetivado == 3 ){ ?>
                    <div class="col-sm-auto col-xs-12 mt-sm-0 mb-3">
                        <a title="Copiar Escala" 
                            class="btn btn-success w-100"
                            href="/escala/copy?id=<?php echo $escal['escala']->id ?>">Copiar Escala</a>
                    </div>
                    <div class="col-sm-auto col-xs-12 mt-sm-0 mb-3">
                        <a title="Imprimir Escala" 
                        class="btn btn-warning w-100"
                        href="/escala/print?id=<?php echo $escal['escala']->id ?>"  
