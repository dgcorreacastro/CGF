<main class="py-4">
    ...
    <div class="personContainer">
        <form method="POST" action="/userEscala/update" accept-charset="UTF-8" class="form-horizontal">
            <div class="card-body">

                <div class="card-create-header">
                    <h2 class="darkcyan"><i class="fas fa-users darkcyan"></i> Editar Usuário</h2>
                </div>
                <hr>
