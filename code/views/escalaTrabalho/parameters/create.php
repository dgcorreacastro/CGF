<main class="py-4">
    ...
    <div class="personContainer">
        <form method="POST" action="/setores/store" accept-charset="UTF-8" class="form-horizontal">
            <div class="card-body">

                <div class="card-create-header">
                    <h2 class="darkcyan"><i class="fa fa-building darkcyan"></i> Cadastrar Setores</h2>
                </div>
                <hr>
