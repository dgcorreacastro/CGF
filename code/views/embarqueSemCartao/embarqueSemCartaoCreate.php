...
<form method="POST" action="/embarqueSemCartao/salvar" accept-charset="UTF-8" class="form-horizontal">
<div class="card-body">

<div class="card-create-header">
    <h2 class="pageTitle"> - Adicionar</h2>
</div>
<hr>
...
<input class="form-control" name="horario_embarque" type="time" id="horario_embarque">
</div>
<div class="col-sm-3 col-xs-12">
<label for="numero_talao" class="control-label">N&ordm; do Tal&atilde;o:</label>
<input class="form-control" name="numero_talao" type="text" id="numero_talao">
</div>
<div class="col-sm-3 col-xs-12">
...
<select class="form-control" id="prefixo_veiculo_id" name="prefixo_veiculo_id">
    <?php foreach($prefVeiculo as $prefv): ?>
        <option value="<?php echo $prefv['id']; ?>"><?php echo utf8_decode(utf8_encode($prefv['NOME'])); ?></option>
    <?php endforeach; ?>
</select>
</div>
...
<select class="form-control" id="cliente_id" name="cliente_id">
    <?php foreach($cliente as $cli): ?>
        <option value="<?php echo $cli['id']; ?>"><?php echo utf8_decode(utf8_encode($cli['NOME'])); ?></option>
    <?php endforeach; ?>
</select>
</div>
<div class="col-sm-6 col-xs-12">
<label for="nome_passageiro" class="control-label">Nome Passageiro:</label>
<input class="form-control phone" name="nome_passageiro" type="text" id="nome_passageiro">
</div>
<div class="col-sm-6 col-xs-12">
...
<select class="form-control" id="linha_id" name="linha_id">
    <?php foreach($linhas as $li): ?>
        <option value="<?php echo $li['id']; ?>"><?php echo utf8_decode(utf8_encode($li['NOME'])) .' - '. utf8_decode(utf8_encode($li['PREFIXO'])); ?></option>
    <?php endforeach; ?>
</select>
</div>
<div class="col-sm-3 col-xs-12">
<label for="registro_passageiro" class="control-label">Registro Passageiro:</label>
<input class="form-control cellphone" name="registro_passageiro" type="text" id="registro_passageiro">
</div>
<div class="col-sm-3 col-xs-12">
...
<select class="form-control" id="grupo_acesso_id" name="grupo_acesso_id">
    <?php foreach($grupoAcesso as $grA): ?>
        <option value="<?php echo $grA['id']; ?>"><?php echo utf8_decode(utf8_encode($grA['NOME'])); ?></option>
    <?php endforeach; ?>
</select>
</div>
</div>
...
<div class="card-create-footer">
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-sm-auto col-xs-12 mt-sm-0 mb-3 w-100">
