<main class="py-4" style="
    ...
    <h4 style="color:#242832;background:white;padding: .3em;width: fit-content;border-radius: 5px;" class="title">Administrador: <b style="margin-left:.2em;" id="nomeBoasVindas"><?php echo $_SESSION["cName"]; ?></b></h4>
    <?php }?>
</main>